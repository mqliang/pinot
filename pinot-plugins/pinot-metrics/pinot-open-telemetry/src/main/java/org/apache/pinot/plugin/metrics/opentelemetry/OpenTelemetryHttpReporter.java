...
public class OpenTelemetryHttpReporter implements PinotMetricReporter {
  ...
  public OpenTelemetryHttpReporter(String otelEndpoint, Map<String, String> otelHeaders, int otelExportIntervalSeconds) {
  ...
  @Override
  public void start() {
    LOGGER.info("Starting OpenTelemetry HTTP Metric Exporter to endpoint: {} which emit metrics every {} seconds with headers: {}",
