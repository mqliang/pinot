...
public abstract class AbstractMetrics<QP extends AbstractMetrics.QueryPhase, M extends AbstractMetrics.Meter,
  ...
  /**
   * Logs the timing for a table with an additional taskType suffix.
   * @param tableName The table associated with this timer
  ...
  public void addMeteredValue(final String prefix, final M meter, final long unitCount, Map<String, String> attributes) {
   ...
   * @param attributes The attributes to attach to the meter
   */
  public PinotMeter addMeteredTableValue(final String tableName, final String prefix, final M meter, final long unitCount,
      PinotMeter reusedMeter, Map<String, String> attributes) {
    String meterName = meter.getMeterName();
